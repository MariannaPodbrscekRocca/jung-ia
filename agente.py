...
<script>
    ...
    const observer = new MutationObserver(function(mutations) {
        ...
        let overlay = parentDoc.getElementById('click-blocker');
        if (!overlay) {
...
TEXTOS = {
    "ESP": {
        ...
        "err_tel": "⚠️ El número de teléfono solo puede contener números, sin espacios ni letras.",
    ...
    "ENG": {
        ...
        "err_tel": "⚠️ Phone number can only contain numbers, no spaces or letters.",
...
st.markdown('<div id="top-circus-anchor"></div>', unsafe_allow_html=True)
